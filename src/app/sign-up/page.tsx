...
export default function SignUpPage() {
  ...
  const handleOtpSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Here you would verify the OTP and create the user account
      ...
      >
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            <CardTitle className="text-3xl font-bold tracking-tight text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600">
              Sign up
            </CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            {!isOtpSent ? (
              <form onSubmit={handleEmailSubmit}>
                ...
                <Button type="submit" className="w-full mt-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white">
                  Send OTP
                </Button>
              </form>
            ) : (
